...
CORS_ALLOWED_ORIGINS = [
    ...
    for origin in os.getenv(
        "CORS_ALLOWED_ORIGINS",
        "http://localhost:5173,http://localhost:5174,http://127.0.0.1:5173,http://127.0.0.1:5174,https://agentic-ai-chat-app-web-client.vercel.app/,https://agentic-ai-api.onrender.com",
    ).split(",")
    if origin.strip()
]

...
import { login, register, googleLogin, healthCheck } from '../api';
...
export default function AuthModal({ open, initialMode, onClose, onSuccess, googleClientId }: AuthModalProps) {
